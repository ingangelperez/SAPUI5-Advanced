		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Employees",
									"targetURL": "#aapgemployees-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"aapgemployees-display": {
								"semanticObject": "aapgemployees",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=aapg.employees",
									"url": sap.ui.require.toUrl("aapg/employees")
								}
							}
						}
					}
